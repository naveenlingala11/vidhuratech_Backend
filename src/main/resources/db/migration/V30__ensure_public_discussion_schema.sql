CREATE TABLE IF NOT EXISTS public_challenge_discussions (
    ...
    author_profile_image_url VARCHAR(1000),
    comment TEXT,
...
ALTER TABLE public_challenge_discussions
    ADD COLUMN IF NOT EXISTS author_name VARCHAR(140);

ALTER TABLE public_challenge_discussions
    ADD COLUMN IF NOT EXISTS author_email VARCHAR(180);

ALTER TABLE public_challenge_discussions
    ADD COLUMN IF NOT EXISTS author_key VARCHAR(140);
